...
{
  "$end", "error", "$undefined", "IDEN", "TYPE", "COM", "COL", "'('",
  "')'", "$accept", "st1", "varDec", "st2", "funcDec", "st3", "st5", YY_NULLPTR
};
#endif
...
{
       2,     3,     9,    10,     4,     7,     9,    10,    11,    17,
      12,    18,    14,    19,    17,    21,    22,    20,     0,    24,
      25,    26,     0,    18,    13,    27,     0,     0,     0,     0,
       0,     0,     0,     0,    23
};
...
{
       0,    10,     0,     1,     4,    11,    13,     3,    12,     5,
       6,     7,     3,    12,     4,    14,    15,     3,     5,     8,
       8,     5,     4,    15,     6,     6,     4,    14
};
...
#line 1232 "y.tab.c" /* yacc.c:1646  */
  ...
  case 6:
#line 16 "prac.y" /* yacc.c:1646  */
    {printf("No of var in line %d is %d\n",countline,countid);countid=0;}
#line 1238 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 17 "prac.y" /* yacc.c:1646  */
    {countid++;}
